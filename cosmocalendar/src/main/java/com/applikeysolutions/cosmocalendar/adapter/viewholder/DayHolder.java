...
public class DayHolder extends BaseDayHolder {
    ...
    public DayHolder(View itemView, CalendarView calendarView) {
        ...
        tvPrice = (TextView) itemView.findViewById(R.id.tv_day_price);
    ...
    public void bind(Day day, BaseSelectionManager selectionManager) {
        ...
        if (day.isCurrent()) {
            ...
            TextView tvToday = new TextView(calendarView.getContext());
            tvToday.setText("Today");
            tvToday.setTextSize(TypedValue.COMPLEX_UNIT_SP, 9);
            tvToday.setGravity(Gravity.CENTER_HORIZONTAL);
            tvToday.setTextColor(ContextCompat.getColor(calendarView.getContext(), R.color.primary_blue));
